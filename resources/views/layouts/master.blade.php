...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-mini"><b>U</b>niv</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>University</b></span>
        </a>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    {{ Auth::user()->email }} - {{ Auth::user()->role == 1 ? "Administrator" : "User" }}
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                @switch(Auth::user()->role)
                    @case(1)
                    <li><a href="/student"><i class="fa fa-book"></i> <span>Students</span></a></li>
                    <li><a href="/card"><i class="fa fa-id-card"></i> <span>Student Cards</span></a></li>
                    <li><a href="/credit"><i class="fa fa-credit-card"></i> <span>Bank Accounts</span></a></li>
                    <li><a href="/club"><i class="fa fa-group"></i> <span>Clubs</span></a></li>
                    <li><a href="/faculty"><i class="fa fa-university"></i> <span>Faculties</span></a></li>
                    <li><a href="/majority"><i class="fa fa-home"></i> <span>Majorities</span></a></li>
                    @break
                    @case(2)
                    <li><a href="/club"><i class="fa fa-group"></i> <span>Clubs</span></a></li>
                    <li><a href="/faculty"><i class="fa fa-university"></i> <span>Faculties</span></a></li>
